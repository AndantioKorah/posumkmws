...
<aside class="main-sidebar elevation-4 sidebar-dark-navy">
  ...
  <a href="<?=base_url('welcome')?>" class="brand-link navbar-navy">
    <!-- <img src="<?=base_url('assets/img/logo-putih-biru.png')?>" alt="NiCash" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
    <!-- <span class="brand-text" style="font-weight: bold; color: white;"><?=TITLE_SECOND?></span> -->
    <img src="<?=$this->general_library->getLogoMerchant()?>" alt="NiCash" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text" style="font-weight: bold; color: white;"><?=$this->general_library->getNamaMerchant()?></span>
  </a>
