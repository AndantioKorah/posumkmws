...
<?php if($result){
    $presentase_penjualan = ($result['total_penjualan_lunas'] / $result['total_penjualan']) * 100;
    $presentase_transaksi = ($result['total_transaksi_lunas'] / $result['total_transaksi']) * 100;
    $presentase_item = ($result['total_item_lunas'] / $result['total_item']) * 100;
?>
    <div class="row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-6" id="table_list_item">
            <div class="card card-default p-3">
                <table class="table table-sm table-hover">
                    ...
                    <tbody>
                        <?php $no=1; $max = $result['list_item'][0]['penjualan']['qty'];
